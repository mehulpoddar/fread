...
(function () {
  ...
  async function callGemini(text) {
    const prompt =
      ...
      '(i) english word (ii) a key grammar concept or verb conjugation used ' +
      '(iii) a short, clever memory tip to help an English speaker remember the French word (mnemonic, sound-alike, visual association, etc).\n\n' +
      'Format: Return ONLY a JSON array:\n' +
      '[{ "en": "...", "fr": "...", "breakdown": [{ "word": "French word", "en": "English equivalent", "grammar": "grammar note", "tip": "memory tip" }] }]\n\n' +
      'Text:\n' + text;
  ...
  function renderBreakdown(container, breakdown) {
    ...
    ['French', 'English', 'Grammar', 'Remember'].forEach(function (label) {
